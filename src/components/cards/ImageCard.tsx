    ...
    return (
      <div className="flex flex-col hover:scale-[1.02] transition-all duration-200 transform-gpu">
        <div 
          ...
          className="bg-gray-100 dark:bg-gray-800 aspect-square flex items-center justify-center cursor-pointer relative shadow-sm hover:shadow-lg rounded-lg"
  ...
  return (
    <div className="flex flex-col hover:scale-[1.02] transition-all duration-200 transform-gpu">
      <div 
        ...
        className="relative cursor-pointer group overflow-hidden shadow-sm hover:shadow-lg rounded-lg"
        style={{ border: '10px solid var(--image-frame-color)' }}
        onClick={handleCardClick}
      >
